  ...
  return allRestaurants?.length === 0 ? (
    ...
    <>
      <div className="p-3 py-8 flex justify-center">
        <input
          type="text"
          className="search-input border px-4 py-2 w-96 rounded-md text-lg placeholder:text-gray-700 "
        ...
        <button
          className="border px-2 ml-2 rounded-md bg-purple-700 hover:bg-purple-600 text-white"
          onClick={() => {
            const data = filterData(searchText, allRestaurants);
            setFilteredRestaurants(data);
          }}
